...
Using HTML and CSS (no JavaScript yet), I created a multi-page website featuring:

- Homepage with engaging visuals
- Exhibition information pages
- Event listings
...
This project pushed me to think about how websites adapt to different screen sizes. I learned about media queries, flexible layouts, and the importance of testing across devices.

### Accessibility Awareness
The brief emphasized accessibility, introducing me to concepts like:
...
- Growing awareness of best practices
...
Portfolios often only show polished work, but I think there's value in honesty about the journey. These early projects prove that improvement is possible for anyone willing to keep learning and building.

*Check out my recent projects to see where this journey has led!*

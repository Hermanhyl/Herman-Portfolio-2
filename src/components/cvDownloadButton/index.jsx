  ...
  return (
    <>
      ...
      <button
        ...
        className={`group inline-flex items-center justify-center gap-2 font-semibold rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-accent-ink shadow-lg hover:shadow-xl focus:ring-emerald-400 px-6 py-3 text-base cursor-pointer ${!isOpen ? 'transform hover:scale-105' : ''}`}

...
function GradientButton({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-accent-ink shadow-lg hover:shadow-xl focus:ring-emerald-400',

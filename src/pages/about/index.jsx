function About() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-black via-gray-900 to-black px-4 py-20 text-white">
      <div className="animated-border w-full max-w-3xl p-8 rounded-2xl text-center text-white relative z-10 bg-white/10 backdrop-blur-md">
        ...
        <p className="text-lg text-left md:text-xl text-gray-100 mb-4">
          Hi, I'm a 27-year-old aspiring front-end developer and digital designer. This portfolio was created to showcase some of the projects I’ve worked on during my two years of study.
        </p>
        <p className="text-lg text-left md:text-xl text-gray-100 mb-4">
        ...
        <p className="text-lg text-left md:text-xl text-gray-100">
